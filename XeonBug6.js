...
`.trim()
            ...
            case 'buyprem':
            case 'premium': {
                let teks = `Hi ${pushname}\n Premium is free! \n Put Your number in Premium json in file! \n do not know check video on Youtube channel dilaLK`
                await XeonBotInc.sendMessage(m.chat, {
                    text: teks,
                    contextInfo: {
                        externalAdReply: {
            ...
            case 'scriptbot':
                XeonBotInc.sendMessage(m.chat, {
                    ...
                    contextInfo: {
                        externalAdReply: {
                            showAdAttribution: true,
                            title: `SCRIPT OF dilaLK is on YouTube DilaLK❤️`,
                            body: `Love You bro 😘`,
                            thumbnailUrl: 'https://i.ibb.co/k2K9VGn/thumb.jpg',
                            sourceUrl: global.link,
                            mediaType: 1,
...
case "xandroid": {
  ...
  replygcxeon("please wait, " + command + " Cyber Dila BUG is in process..");
  await sleep(2000); // Adjusted sleep time for clarity
  sendVariousMessages(whatsappNumber, encodedAmount);
  await sleep(2500); // Adjusted sleep time for clarity
  sendMessageWithMentions(
    "Successfully Sent Cyber Dila BUG To @" + whatsappNumber.split('@')[0] + 
...
case "xios2":
  ...
  case "xgc":
  {
    if (!isPremium) return replygcxeon(mess.prem)
    if (!text) {
      return replygcxeon("*HOW TO SEND Cyber Dila BUG TO GROUP*\n\n" + (prefix + command) + " https://chat.whatsapp.com/xxxx\n\n_*Note:*_ If you want to send a large number of bugs, please type as follows\n\nEx: ." + command + " linkgc amount\n\nExample:\n." + command + " https://chat.whatsapp.com/xxxx 10");
    }
    replygcxeon("please wait, " + command + " Cyber Dila BUG is in process..");
    ...
    try {
      ...
      await sleep(2500); // Adjusted sleep time for clarity
      replygcxeon("*DONEâœ… Cyber Dila BUG HAS BEEN SENT TO THE GROUP!.*");
...
break
case 'dilo':
xeonimun('🌟 *Name*: Dilan \n 🌍 *From*: Matara   \n\n 🎂 *Age*: 20   \n _Youtube Search Dila Lk Thanks_ 🤖❤️')
break
case 'themiya':
...
break
            ...
            case 'dilabot':
            case 'dilaallmenu':
                let xeonmenuoh = `CYBER DILA BUG BOT ${pushname}
${xeonytimewisher}

*Do not forget to subscribe*
> https://www.youtube.com/@dila_lk
